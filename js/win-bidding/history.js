...
function renderCollect(element, data, total, index) {
    ...
    for (var i = 0, length = data.length; i < length; i++) {
        ...
        html +=
            ...
            "<td  ><a  style='display: inline-block;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;width: 377px;' target='_blank' href='bidding_information_detail.html?id=" + data[i].infoId + " '> " +
            data[i].title +
            "</a></td>" +
            "<td style=''>" +
            data[i].region +
